...
export function buildAttendanceCsv(
  ...
  const rows: Array<Array<string | number | boolean | null | undefined>> = [
    ...
    ['Tempo médio da primeira resposta hoje (segundos)', metrics.tempo_medio_primeira_resposta_hoje],
    ['Tempo médio da primeira resposta no mês (segundos)', metrics.tempo_medio_primeira_resposta_periodo],
    ['Tempo médio da primeira resposta acumulada (segundos)', metrics.tempo_medio_primeira_resposta],
