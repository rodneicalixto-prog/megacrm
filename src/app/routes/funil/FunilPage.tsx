        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-[rgb(var(--accent-rgb)/0.25)] bg-white/[0.03] px-3 py-2 text-sm text-[var(--color-text-primary)] transition hover:border-[var(--accent-primary)]"
            >
              {pipeline?.name ?? 'Funil'}
            ...
            {pickerOpen && (
              <>
                ...
                <div className="absolute right-0 z-20 mt-1 w-56 rounded-lg border border-[var(--color-border-card)] bg-[var(--color-bg-elevated)] p-1 shadow-[0_0_30px_rgb(var(--accent-rgb)/0.15)]">
                  {pipelines.map((p) => (
                    <button
                      key={p.id}
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[rgb(var(--accent-rgb)/0.25)] px-3 py-2 text-sm text-[var(--accent-secondary)] transition hover:border-[var(--accent-primary)]"
          >
          ...
          <button
            ...
            className={[
              ...
              selectMode
                ...
                : 'border-[rgb(var(--accent-rgb)/0.25)] text-[var(--color-text-secondary)] hover:border-[var(--accent-primary)]',
            ].join(' ')}
          >
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-[#1E3A8A] to-[var(--accent-primary)] px-3 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
            >
            ...
            {quickAddOpen && (
              <>
                ...
                <div className="absolute right-0 z-20 mt-1 w-64 rounded-lg border border-[var(--color-border-card)] bg-[var(--color-bg-elevated)] p-3 shadow-[0_0_30px_rgb(var(--accent-rgb)/0.15)]">
                  <AddDealForm
                    contacts={contacts}
                    stages={stages}
        ...
        <div className="glass-card flex flex-wrap items-center gap-3 p-3">
          ...
          <label className="inline-flex items-center gap-1.5 text-xs text-[var(--color-text-secondary)]">
            ...
            <select
              ...
              className="rounded-md border border-[rgb(var(--accent-rgb)/0.2)] bg-white/[0.03] px-2 py-1 text-xs text-[var(--color-text-primary)] outline-none focus:border-[var(--accent-primary)] [&>option]:bg-[var(--color-bg-elevated)]"
            >
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-1 rounded-md border border-[rgb(var(--accent-rgb)/0.2)] px-2.5 py-1 text-xs text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]"
          >
          ...
          {stages.map((stage) => {
            ...
            return (
              <div
                ...
                className="flex w-72 shrink-0 flex-col rounded-xl border border-[rgb(var(--accent-rgb)/0.12)] bg-white/[0.02]"
              >
                <div className="flex items-center justify-between border-b border-[rgb(var(--accent-rgb)/0.1)] px-3 py-2.5">
                ...
                <div className="flex-1 space-y-2 p-3">
                  ...
                  {remaining > 0 && (
                    <button
                      ...
                      className="w-full rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]"
                    >
                  ...
                  {adding === stage.id ? (
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1 rounded-lg border border-dashed border-[rgb(var(--accent-rgb)/0.25)] py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]"
                    >
...
function DealCard({
  ...
  return (
    <div
      ...
      className={[
        'cursor-pointer p-3 transition rounded-xl border shadow-[0_0_20px_rgb(var(--accent-rgb)/0.06),inset_0_1px_0_rgb(var(--accent-rgb)/0.1)]',
        selected
          ? 'border-[var(--accent-primary)] ring-1 ring-[var(--accent-primary)]'
          : 'border-[rgb(var(--accent-rgb)/0.25)] hover:border-[rgb(var(--accent-rgb)/0.45)]',
...
function AddDealForm({
  ...
  return (
    <form
      ...
      className="space-y-2 rounded-lg border border-[rgb(var(--accent-rgb)/0.2)] bg-white/[0.03] p-2"
    >
      {stages && (
      ...
      <div className="flex gap-2">
        ...
        <button type="button" onClick={onCancel} className="rounded-md border border-[rgb(var(--accent-rgb)/0.2)] px-2 py-1 text-xs text-[var(--color-text-secondary)]">
          <X className="h-3 w-3" />
        </button>
      </div>
    </form>
