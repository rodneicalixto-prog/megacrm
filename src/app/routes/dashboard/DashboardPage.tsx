        ...
        <div className="grid w-full gap-3 sm:w-auto sm:grid-cols-3">
          <label className="w-full sm:w-56">
            ...
            <select
              ...
              className="min-h-11 w-full rounded-lg border border-[rgb(var(--accent-rgb)/0.25)] bg-[var(--color-bg-elevated)] px-3 text-sm text-[var(--color-text-primary)] outline-none transition focus:border-[var(--accent-primary)] disabled:opacity-50"
            >
