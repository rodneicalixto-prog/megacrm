    ...
    <div className="glass-card p-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-[rgba(239,68,68,0.3)]">
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-[rgb(var(--accent-rgb)/0.25)] bg-white/[0.03] px-4 text-sm font-medium text-[var(--color-text-primary)] transition-all duration-[0.4s] [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] hover:border-[color:var(--accent-primary)] hover:shadow-[0_0_30px_rgb(var(--accent-rgb)/0.25)]"
        >
