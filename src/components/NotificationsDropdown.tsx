...
export function NotificationsDropdown() {
  ...
  return <div className="relative" ref={containerRef}>
    ...
    {open && <div className="absolute right-0 z-50 mt-2 flex max-h-[70vh] w-[340px] max-w-[calc(100vw-1.5rem)] flex-col overflow-hidden rounded-lg border border-[rgba(59,130,246,0.25)] bg-[#0F1223] shadow-2xl">
