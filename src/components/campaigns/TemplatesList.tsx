...
export function TemplatesList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-[rgb(var(--accent-rgb)/0.15)] bg-[rgb(var(--accent-rgb)/0.05)] px-4 py-3 text-sm text-[var(--color-text-secondary)]">
