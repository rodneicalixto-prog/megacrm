-- Dashboard operacional por setor e por linha/número.
--
-- A linha é department_connections.id, persistida em conversations.connection_id.
-- NULL mantém o consolidado para preservar o comportamento atual.

CREATE SCHEMA IF NOT EXISTS whatsapp_hub;
SET search_path TO whatsapp_hub, public;

DROP FUNCTION IF EXISTS whatsapp_hub.attendance_dashboard(UUID, TEXT, INT);
...
GRANT EXECUTE ON FUNCTION whatsapp_hub.attendance_dashboard(UUID, UUID, TEXT, INT) TO authenticated;
